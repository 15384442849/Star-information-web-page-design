...
<head>
	...
	<style type="text/css">
		body{
		background-image: url("../../img/hezhao3.jpg");
		background-repeat: no-repeat;
		background-size: 100%;
		background-color:#8146F8;
	}
	#all{
		margin: 0 auto;
		width: 1250px;
...
<div id="all">
    ...
    <form action="action-editnews.php" method="post" id="ot">
		<div id="one">
    <label>资料编号: </label><input type="text" name="id" value="<?php echo $row['id']?>">
    ...
    <label>关键字：</label><input type="text" name="keywords" value="<?php echo $row['keywords']?>"></div>
		<div id="two">
    <label>明星名字：</label><input type="text" name="autor" value="<?php echo $row['autor']?>">
